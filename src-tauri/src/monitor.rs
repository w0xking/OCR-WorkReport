...
pub fn normalize_display_app_name(app_name: &str) -> String {
    ...
    {
        return "Work Report Setup".to_string();
    }
    ...
    match normalized.as_str() {
        // ── 本应用 ──
        "work-review" | "work_review" | "workreview" | "work report" => "Work Report".to_string(),
        // ── 浏览器 ──
...
fn normalize_electron_app_name(process_name: &str, window_title: &str) -> String {
    ...
    let process_aliases = [
        ("work-review", "Work Report"),
        ("work_review", "Work Report"),
        ("workreview", "Work Report"),
    ];
