...
mod tests {
    ...
    fn 域名提取应返回标准host() {
        assert_eq!(
            normalize_domain_from_url("https://github.com/w0xking/Work_Review/pull/128"),
    ...
    fn 会话项目key应稳定包含应用和域名() {
        let sessions = build_work_sessions(&[sample_activity(
            ...
            "Google Chrome",
            "PR #128 · 支付回调修复",
            Some("https://github.com/w0xking/Work_Review/pull/128"),
            900,
        )]);
    ...
    fn 回到同类项目时应命中继续建议() {
        ...
        let active_window = ActiveWindow {
            ...
            browser_url: Some("https://github.com/w0xking/Work_Review/pull/128".to_string()),
            executable_path: None,
            window_bounds: None,
            is_minimized: false,
        };
